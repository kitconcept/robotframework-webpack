...
Documentation   WebpackLibrary Webpack 4 Test
...
Start Webpack and Open Browser
  Start Webpack  node_modules/webpack-dev-server/bin/webpack-dev-server.js --mode development  path=tests/test-webpack-4
